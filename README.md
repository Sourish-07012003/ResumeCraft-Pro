...
- **Resume Editor:** Add and edit personal information, summary, skills, and experience.
- **Live Preview:** See real-time updates of your resume while editing.
- **Download PDF:** Export the resume as a PDF file.
- **Responsive Design:** Works on desktop and mobile devices.
- **Secure Backend:** Node.js + Express + MongoDB for data storage and authentication.
